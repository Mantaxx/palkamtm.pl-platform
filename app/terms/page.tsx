                    ...
                    <div className="rounded-lg border-2 border-white p-8" style={{
                        ...
                        <div className="prose prose-lg max-w-none text-white/90">
                                ...
                                <div className="flex">
                                    ...
                                    <div className="ml-3">
                                        <p className="text-sm text-yellow-300 font-medium">
                                            ...
                                            Właściciel serwisu nie ponosi jakiejkolwiek odpowiedzialności za treść ogłoszeń, przedmiot aukcji oraz przebieg i wykonanie transakcji.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul className="space-y-3 mb-8 text-white/90">
                                ...
                                <li><strong>Sprzedający</strong> – Użytkownik publikujący Ofertę sprzedaży gołębia pocztowego.</li>
                                <li><strong>Kupujący</strong> – Użytkownik biorący udział w licytacji w celu zakupu gołębia pocztowego.</li>
                                <li><strong>Aukcja</strong> – procedura prowadząca do zawarcia umowy sprzedaży pomiędzy Sprzedającym a Kupującym, który zaoferował najwyższą cenę.</li>
                            ...
                            <ul className="space-y-3 mb-8 text-white/90">
                                ...
                                <li><strong>f.</strong> <strong>Działania Użytkowników:</strong> Usługodawca nie odpowiada za jakiekolwiek czyny lub zaniechania Użytkowników, w tym za naruszenie przez nich praw autorskich, dóbr osobistych czy innych praw osób trzecich.</li>
