export const metadata = {
    ...
    description: 'Polityka Prywatności Serwisu Aukcyjnego Gołębie Pocztowe - zasady przetwarzania i ochrony danych osobowych.',
}
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                        <div className="prose prose-lg max-w-none">
                            ...
                            <div className="space-y-6 mb-8">
                                <div>
                                    ...
                                    <ul className="ml-6 space-y-2">
                                        <li><strong>Zakres danych:</strong> Adres e-mail, login (nazwa użytkownika), hasło (w formie zaszyfrowanej), historia licytacji i ofert. Opcjonalnie: imię i nazwisko, numer telefonu, adres.</li>
                                        <li><strong>Podstawa prawna:</strong> Art. 6 ust. 1 lit. b RODO – niezbędność do wykonania umowy o świadczenie usług drogą elektroniczną.</li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="ml-6 space-y-2">
                                        <li><strong>Zakres danych:</strong> Imię i nazwisko, adres, numer telefonu, adres e-mail Sprzedającego i Kupującego, który wygrał aukcję.</li>
                                        <li><strong>Podstawa prawna:</strong> Art. 6 ust. 1 lit. f RODO – prawnie uzasadniony interes Administratora, polegający na umożliwieniu stronom transakcji jej sfinalizowania.</li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="ml-6 space-y-2">
                                        <li><strong>Zakres danych:</strong> Dane niezbędne do wystawienia faktur i prowadzenia dokumentacji księgowej (jeśli dotyczy).</li>
                                        <li><strong>Podstawa prawna:</strong> Art. 6 ust. 1 lit. c RODO – niezbędność do wypełnienia obowiązku prawnego (np. przepisy podatkowe).</li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="ml-6 space-y-2">
                                        <li><strong>Zakres danych:</strong> Adres IP, typ przeglądarki, system operacyjny, dane o aktywności w Serwisie.</li>
                                        <li><strong>Podstawa prawna:</strong> Art. 6 ust. 1 lit. f RODO – prawnie uzasadniony interes Administratora, polegający na poprawie funkcjonowania Serwisu.</li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="ml-6 space-y-2">
                                        <li><strong>Zakres danych:</strong> Wszelkie dane podane przez Użytkownika.</li>
                                        <li><strong>Podstawa prawna:</strong> Art. 6 ust. 1 lit. f RODO – prawnie uzasadniony interes Administratora, polegający na ochronie jego praw.</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <ul className="space-y-3 mb-8">
                                ...
                                <li>Po usunięciu konta dane mogą być przechowywane przez okres niezbędny do:
                                    <ul className="ml-6 mt-2 space-y-2">
                                        <li>Dochodzenia lub obrony przed ewentualnymi roszczeniami (do czasu ich przedawnienia).</li>
                                        <li>Wypełnienia obowiązków prawnych (np. wynikających z przepisów podatkowych – zazwyczaj 5 lat od końca roku kalendarzowego, w którym dokonano transakcji).</li>
                                    </ul>
                                </li>
                            ...
                            <ul className="space-y-2 mb-4">
                                ...
                                <li><strong>Prawo do wniesienia skargi</strong> do organu nadzorczego, tj. Prezesa Urzędu Ochrony Danych Osobowych (ul. Stawki 2, 00-193 Warszawa).</li>
                            </ul>
                            <p className="mb-8">
                            ...
                            <ul className="space-y-3 mb-4">
                                <li><strong>Cookies niezbędne:</strong> Konieczne do prawidłowego funkcjonowania Serwisu, w tym do obsługi logowania i utrzymania sesji Użytkownika. Nie można ich wyłączyć.</li>
                                <li><strong>Cookies analityczne/opcjonalne:</strong> Wykorzystywane do zbierania anonimowych danych statystycznych o sposobie korzystania z Serwisu w celu jego optymalizacji (np. Google Analytics). Są one instalowane wyłącznie za zgodą Użytkownika.</li>
                            </ul>
                            <p className="mb-8">
