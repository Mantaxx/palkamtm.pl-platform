          ...
          <div className="sticky top-0 bg-gradient-to-r from-slate-800 via-slate-700 to-slate-600 text-white p-6 rounded-t-2xl">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-blue-100">{champion.ringNumber} • {champion.bloodline}</p>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-gradient-to-br from-slate-100 to-slate-200 rounded-xl p-6 border-2 border-slate-300">
                  ...
                  <div className="bg-white rounded-lg p-4 shadow-sm">
                    <h6 className="font-bold text-lg text-gray-900 mb-2">{champion.pedigree.father.name}</h6>
                ...
                <div className="bg-gradient-to-br from-slate-200 to-slate-300 rounded-xl p-6 border-2 border-slate-400">
                  ...
                  <div className="bg-white rounded-lg p-4 shadow-sm">
                    <h6 className="font-bold text-lg text-gray-900 mb-2">{champion.pedigree.mother.name}</h6>
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center space-x-2">
                        <MapPin className="w-4 h-4 text-gray-500" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl p-6 border-2 border-slate-200">
                  ...
                  <div className="bg-white rounded-lg p-4 shadow-sm">
                    <h6 className="font-bold text-lg text-gray-900 mb-2">{champion.pedigree.grandfather.name}</h6>
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center space-x-2">
                        <MapPin className="w-4 h-4 text-gray-500" />
                        <span className="text-gray-600">{champion.pedigree.grandfather.ringNumber}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Calendar className="w-4 h-4 text-gray-500" />
                        <span className="text-gray-600">{champion.pedigree.grandfather.bloodline}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl p-6 border-2 border-slate-200">
                  ...
                  <div className="bg-white rounded-lg p-4 shadow-sm">
                    <h6 className="font-bold text-lg text-gray-900 mb-2">{champion.pedigree.grandmother.name}</h6>
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center space-x-2">
                        <MapPin className="w-4 h-4 text-gray-500" />
                        <span className="text-gray-600">{champion.pedigree.grandmother.ringNumber}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Calendar className="w-4 h-4 text-gray-500" />
                        <span className="text-gray-600">{champion.pedigree.grandmother.bloodline}</span>
                      </div>
                    </div>
                  </div>
                </div>
