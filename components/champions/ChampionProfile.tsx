...
export function ChampionProfile({ champion }: ChampionProfileProps) {
  const [activeTab, setActiveTab] = useState<'gallery' | 'pedigree' | 'results' | 'offspring'>('gallery')
            ...
            >
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span>Data urodzenia: {format(new Date(champion.birthDate), 'dd MMMM yyyy', { locale: pl })}</span>
                </div>
                <div className="flex items-center space-x-3">
              ...
              >
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                  <div className="px-8 py-6 border-b border-gray-200">
                    <h3 className="font-display font-bold text-2xl text-gray-900">Wyniki Zawodów</h3>
                  </div>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      <thead className="bg-gray-50">
                        <tr>
                          <th className="px-6 py-4 text-left text-sm font-medium text-gray-900">Zawody</th>
                          <th className="px-6 py-4 text-left text-sm font-medium text-gray-900">Miejsce</th>
                          <th className="px-6 py-4 text-left text-sm font-medium text-gray-900">Data</th>
                          <th className="px-6 py-4 text-left text-sm font-medium text-gray-900">Dystans</th>
                          <th className="px-6 py-4 text-left text-sm font-medium text-gray-900">Uczestnicy</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-gray-200">
                        {champion.achievements.map((achievement, index) => (
                          <tr key={index} className="hover:bg-gray-50">
                            <td className="px-6 py-4 text-sm text-gray-900">{achievement.competition}</td>
                            <td className="px-6 py-4">
                              <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${achievement.place === 1
                            ...
                            <td className="px-6 py-4 text-sm text-gray-600">{achievement.distance}</td>
                            <td className="px-6 py-4 text-sm text-gray-600">{achievement.participants}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                  ...
                  {champion.offspring.map((child, index) => (
                    ...
                    >
                      <div className="flex items-center space-x-4 mb-4">
                        ...
                        <div>
                          <h4 className="font-display font-bold text-xl text-gray-900">{child.name}</h4>
