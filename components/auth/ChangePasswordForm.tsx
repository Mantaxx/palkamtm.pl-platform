        ...
        >
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p className="text-white/70 text-sm">Zaktualizuj swoje hasło dla większego bezpieczeństwa</p>
                </div>
            </div>
            ...
            <div className="mt-4 p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                <p className="text-blue-300 text-sm">
                    <strong>Wskazówka:</strong> Używaj silnego hasła z co najmniej 8 znakami, zawierającego litery, cyfry i znaki specjalne.
                </p>
            </div>
        </motion.div>
    )
