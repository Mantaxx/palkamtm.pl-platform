      ...
      >
        ...
        >
          <Text3D
            variant="glow"
            intensity="medium"
            className={`${textSizeClasses[size]} mb-2`}
          >
        ...
        <div className="space-y-4">
          {steps.map((step, index) => (
            <motion.div
              ...
              className={`flex items-center space-x-3 ${index === currentStep ? 'text-white' : 'text-gray-400'
                }`}
            >
              <motion.div
                className={`w-2 h-2 rounded-full ${index <= currentStep ? 'bg-white' : 'bg-gray-500'
                  }`}
