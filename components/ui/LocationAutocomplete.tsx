    ...
    <div className={`relative ${className}`}>
      <div className="relative">
        ...
        <input
          ...
          className={`w-full pl-10 pr-10 py-2 bg-white/50 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-400 text-black placeholder-gray-500 ${error ? 'border-red-500' : ''
            }`}
