...
export default function AdminDashboard() {
    ...
    const [editingBids] = useState<Bidder[]>([])
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 text-white">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-3">
                        ...
                        >
                            {activeTab === 'overview' && (
                                <AdminOverview stats={stats} isLoading={isLoading} />
                            )}
                            ...
                            {activeTab === 'auctions' && (
                                <AdminAuctions
                                    ...
                                    onAuctionDataChange={(field, value) => setEditingAuctionData((prev: Partial<Auction>) => ({ ...prev, [field]: value }))}
                                    onBidChange={() => { }}
                                    onSaveBids={() => { }}
                                />
                            )}
