...
export function MessagesList({ conversations, onSelectConversation, selectedConversationId }: MessagesListProps) {
  return (
            ...
            <div className="space-y-1">
              {conversations.map((conversation) => (
                <button
                  ...
                  className={`w-full p-4 text-left hover:bg-gray-700/50 transition-colors ${selectedConversationId === conversation.id ? 'bg-gray-700/50' : ''
                    }`}
                >
